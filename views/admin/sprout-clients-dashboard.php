	...
	<div class="welcome_content">
		...
		<div class="feature-section col three-col clearfix">
			...
			<div class="last-feature">
				...
				<p><?php printf( "<a href='https://sproutapps.co/support/' target='_blank' class='button'>%s</a>", __( 'Support' , 'sprout-invoices' ) ); ?>&nbsp;<?php printf( "<a href='https://docs.sproutapps.co' target='_blank' class='button'>%s</a>", __( 'Documentation' , 'sprout-invoices' ) ); ?></p>
